CREATE OR REPLACE FUNCTION test_audit()
	...
	DECLARE conn_data VARCHAR = 'host=127.0.0.1 port=5432 dbname=audit user=root password=1234 options=-csearch_path=';
...
BEGIN
	...
	VALUES (id, 'Spanich', 'Español', true, false, 1, 2, 'left');
